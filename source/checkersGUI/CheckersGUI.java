...
public class CheckersGUI extends JFrame implements MouseListener,
	...
	private String languageSelect = "pt";
	...
	private void initActions() {
		...
		escolherLang = new AbstractAction() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (dialog.isAccepted()) {
					ResourceBundle bundle = new TradutionLang(languageSelect).getBundle(languageSelect);
					System.out.println(bundle.getString("NG"));
					repaint();
				}
				dialog.dispose();
		...
		escolherLang.putValue(Action.NAME, "Language");
